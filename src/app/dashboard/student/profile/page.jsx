...
export default function ProfilePage() {
    ...
    if (!user_id) router.replace("/dashboard/student");
    ...
    /* fetch data */
    useEffect(() => {
        getProfileForUser.student(user_id).then((data) => setData(data.student)).then(() => setLoading(false));
    }, [user_id]);
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                                        ...
                                        <span className="text-gray-400">
                                            ...
                                            <div className="pt-2">
                                                <Link href="/forgot-password" >
                                                    <button className="inline-flex items-center gap-2 text-sm font-medium text-primary hover:text-blue-700 transition-colors"
                                                        type="button">
                                                        <span>
                                                            <LockKeyhole size={24} />
                                                        </span>
                                        ...
                                        <span className="text-gray-400">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <div className="relative">
                                                    <input className="w-full rounded-md border border-gray-700 bg-gray-800 px-3 py-2.5 text-sm text-gray-400 cursor-not-allowed outline-none pr-10"
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <div className="relative">
                                                    <input className="w-full rounded-md border border-gray-600 bg-[#1a202c] pl-10 pr-3 py-2.5 text-sm text-gray-400 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all"
