...
DROP PROCEDURE IF EXISTS register_supervisor//

CREATE PROCEDURE register_supervisor (
...
BEGIN
    ...
    START TRANSACTION;
		...
		VALUES (p_first_name, p_second_name, p_email, p_password, 'supervisor');
		...
		VALUES (
			...
			v_user_id,
			CONCAT('Supervisor registered: ', p_email)
		);
    COMMIT;
END//
DELIMITER ;